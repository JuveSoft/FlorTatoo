...
//         imagen.innerTML = `
//         <img loading="lazy" width="200" heigt="300" src="build/img/${i}.jpg" alt="Foto_flor">
//         `
...
function crearGaleria() {
    ...
    for (let i = 1; i <= 34; i++) {
        ...
        `;
        //image.onclick=mostrarImagen(i); Si la queremos mostrar de esta manera no va a mostrartodos los nomeros . por eso es mas conveniente usarlo como el modelo siguiente que se lllama callback
